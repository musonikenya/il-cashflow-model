      	...
      	*/
      	$urlExtention = "/datatables/cct_CashFlowCrops/" . $loanId; //get the loan ID from the webhook post
      		...
      		//	"YesNo_cd_Add_a_crop": "243",
                      ...
                      $harvestMonth =		$this->CI->cashflowdropdownslibrary->receiveCashFlowHarvestMonthDropdownData($cashflowCrops['0']['Cashflow_Harvest_month_cd_Month_of_harvest_crop_11']); //month
                      $fertilizer =		$this->CI->cashflowdropdownslibrary->receiveCashFlowFertilizersYesNoDropdownData($cashflowCrops['0']['Cashflow_FertizersYesNo_cd_Use_fertilizers_crop_1']); //dropdown fertilizer
                    	...
                    	$month =		$this->CI->cashflowdropdownslibrary->receiveCashFlowPlantingMonthDropdownData($cashflowCrops['0']['Cashflow_Month_Crops_cd_Next_month_of_planting_crop_11']); //dropdown month
      							...
      							//checking if the second crop is selected
      									...
      									//	"YesNo_cd_Add_a_second_crop": "243",
      														...
      														//	$harvestMonth =		$this->CI->cashflowdropdownslibrary->receiveCashFlowMonthDropdownData($cashflowCrops['0']['Cashflow_Month_cd_Month_of_harvest_crop_21']); //month
      															$harvestMonth =		$this->CI->cashflowdropdownslibrary->receiveCashFlowHarvestMonthDropdownData($cashflowCrops['0']['Cashflow_Month_cd_Month_of_harvest_crop_21']); //month
      														...
      														//	$month =		$this->CI->cashflowdropdownslibrary->receiveCashFlowMonthDropdownData($cashflowCrops['0']['Cashflow_Month_cd_Crop_2Month_planting']); //dropdown month
      															$month =		$this->CI->cashflowdropdownslibrary->receiveCashFlowPlantingMonthDropdownData($cashflowCrops['0']['Cashflow_Month_Crops_cd_Crop_2Month_planting_2']); //dropdown month
      													...
      													//Checking if the 3rd crop is selected
      															...
      															//	"YesNo_cd_Add_a_third_crop": "243",
      																					...
      																					$harvestMonth =		$this->CI->cashflowdropdownslibrary->receiveCashFlowHarvestMonthDropdownData($cashflowCrops['0']['Cashflow_Harvest_month_cd_Month_of_harvest_crop_31']); //month
      																				...
      																				//	$month =		$this->CI->cashflowdropdownslibrary->receiveCashFlowMonthDropdownData($cashflowCrops['0']['Cashflow_Month_cd_Crop_2Month_planting']); //dropdown month
      																					$month =		$this->CI->cashflowdropdownslibrary->receiveCashFlowPlantingMonthDropdownData($cashflowCrops['0']['Cashflow_Month_Crops_cd_Crop_3Month_planting_2']); //dropdown month
      																				...
      																				//Checking if 4th crop has been added
      																					if ($cashflowCrops['0']['YesNo_cd_Add_a_fourth_crop'] == 243) {
      																							...
      																							//	"YesNo_cd_Add_a_fourth_crop": "243",
      																											...
      																											$harvestMonth =		$this->CI->cashflowdropdownslibrary->receiveCashFlowHarvestMonthDropdownData($cashflowCrops['0']['Cashflow_Harvest_month_cd_Month_of_harvest_crop_41']); //month
      																											...
      																											$month =		$this->CI->cashflowdropdownslibrary->receiveCashFlowPlantingMonthDropdownData($cashflowCrops['0']['Cashflow_Month_Crops_cd_Crop_4Month_planting_2']); //dropdown month
      																										...
      																										if ($cashflowCrops['0']['YesNo_cd_Add_a_fifth_crop'] == 243) {
      																											...
      																											//	"YesNo_cd_Add_a_fifth_crop": "243",
      																															...
      																															//	$harvestMonth =		$this->CI->cashflowdropdownslibrary->receiveCashFlowMonthDropdownData($cashflowCrops['0']['Cashflow_Month_cd_Month_of_harvest_crop_5']); //month
      																																$harvestMonth =		$this->CI->cashflowdropdownslibrary->receiveCashFlowHarvestMonthDropdownData($cashflowCrops['0']['Cashflow_Harvest_month_cd_Month_of_harvest_crop_51']); //month
      																															...
      																															//	$month =		$this->CI->cashflowdropdownslibrary->receiveCashFlowMonthDropdownData($cashflowCrops['0']['Cashflow_Month_cd_Crop_5Month_planting_crop_5']); //dropdown month
      																																$month =		$this->CI->cashflowdropdownslibrary->receiveCashFlowPlantingMonthDropdownData($cashflowCrops['0']['Cashflow_Month_Crops_cd_Crop_5Month_planting_2']); //dropdown month
